...
async function fetchRemoteData(opts) {
    ...
    const payload = await nodeFetch(`https://retroachievements.org/dorequest.php?r=patch&t=${token}&u=${username}&g=${gameId}`, {
        headers: {
...
export async function getRemoteData({ gameId, refetch, timeout, }) {
    const filePath = resolveRACache(`./RACache/Data/${gameId}.json`);
