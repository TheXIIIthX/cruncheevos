...
export default async function diffSave(inputFilePath, opts) {
    const { refetch, excludeUnofficial, contextLines, forceRewrite, filter = [], timeout = 1000, } = opts;
    ...
    if (inputSetIsEmpty) {
        log(chalk.yellowBright(`set doesn't define any achievements or leaderboards, diff-save aborted`));
        return;
    }
    try {
