(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.cruncheevos = {}));
  ...
  function achievementDataFromString(str) {
    ...
    const def = {
      id: validate$3.andNormalizeId(id),
      setId: setId === void 0 ? setId : validate$3.andNormalizeId(setId, "setId"),
      title: col[2],
      description: col[3],
      type,
      author: col[7],
  ...
  class Achievement {
    constructor(def) {
      ...
      if (typeof def === "string") {
        ...
        Object.assign(this, {
          ...
          setId: def.setId === void 0 ? def.setId : validate$3.andNormalizeId(def.setId, "setId"),
          title: def.title,
      ...
      validate$3.string(this.title, "title");
      validate$3.string(this.description, "description");
    ...
    toString(desiredData = "achievement") {
      ...
      if (desiredData === "conditions") {
        ...
        let res = "";
        res += this.id;
        if (desiredData === "achievement" && this.setId !== void 0) {
          res += "|" + this.setId;
        }
        res += ":";
        res += `"${conditions}":`;
  ...
  class Leaderboard {
    ...
    toString(desiredData = "leaderboard") {
      ...
      if (desiredData === "conditions") {
        ...
        let res = "";
        res += "L" + this.id;
        if (desiredData === "leaderboard" && this.setId !== void 0) {
          res += "|" + this.setId;
        }
        res += ":";
        res += conditions.join(":") + ":";
  ...
  class AchievementSet {
    ...
    constructor(opts) {
      ...
      if (id !== void 0) {
        this.id = validate$3.andNormalizeId(id, "id");
      }
      validate$3.nonEmptyString(title, "achievement set title");
      this.title = title;
      privateMap.set(this, {
...
${key}=${finalValues[inputKey]}`;
  ...
  exports2.Achievement = Achievement;
  exports2.AchievementSet = AchievementSet;
  exports2.Condition = Condition;
  exports2.ConditionBuilder = ConditionBuilder;
  exports2.Leaderboard = Leaderboard;
  exports2.RichPresence = RichPresence;
  exports2.addHits = addHits;
  exports2.andNext = andNext;
  exports2.define = define2;
  exports2.measured = measured;
  exports2.measuredIf = measuredIf;
  exports2.measuredPercent = measuredPercent;
  exports2.once = once;
  exports2.orNext = orNext;
  exports2.pauseIf = pauseIf;
  exports2.resetIf = resetIf;
  exports2.resetNextIf = resetNextIf;
  exports2.stringToNumberLE = stringToNumberLE;
  exports2.subHits = subHits;
