...
set.addAchievement({
  ...
  conditions: {
    ...
    alt1: $(
      ...
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9100, '=', 'Value', '', 0],
      ['OrNext', 'Mem', '32bitBE', 0x2c9110, '=', 'Value', '', 1],
...
set.addAchievement({
  ...
  conditions: {
    ...
    alt1: $(
      ['MeasuredIf', 'Mem', '8bit', 0x2c8b58, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c90f8, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9100, '=', 'Value', '', 1],
      ['OrNext', 'Mem', '32bitBE', 0x2c9110, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9110, '=', 'Value', '', 2],
...
set.addAchievement({
  ...
  conditions: {
    ...
    alt1: $(
      ['MeasuredIf', 'Mem', '8bit', 0x2c8b58, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c90f8, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9100, '=', 'Value', '', 2],
      ['OrNext', 'Mem', '32bitBE', 0x2c9110, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9110, '=', 'Value', '', 2],
...
set.addAchievement({
  ...
  conditions: {
    ...
    alt1: $(
      ['MeasuredIf', 'Mem', '8bit', 0x2c8b58, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c90f8, '=', 'Value', '', 2],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9100, '=', 'Value', '', 0],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9180, '=', 'Value', '', -1],
      ['Measured', 'Mem', '32bitBE', 0x3a3b6c, '>=', 'Value', '', 40],
    ),
    alt2: $(
      ['MeasuredIf', 'Mem', '8bit', 0x2c8b58, '=', 'Value', '', 1],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c90f8, '=', 'Value', '', 2],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9100, '=', 'Value', '', 0],
      ['MeasuredIf', 'Mem', '32bitBE', 0x2c9178, '=', 'Value', '', -1],
      ['Measured', 'Mem', '32bitBE', 0x3a3b70, '>=', 'Value', '', 40],
    ),
  },
  badge: '655658',
  id: 571303,
