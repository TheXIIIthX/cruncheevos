...
export const remoteRefetchRecommendation = `you can try to delete remote data and run the command again, ` +
...
export function calculateSetChanges(inputSet, remoteSet, localData, filters = []) {
    ...
    for (const local of localEntries) {
        if (local.type === 'error') {
            ...
            log(util.styleText('yellowBright', `local file, ignoring line ${local.idx}: ${local.err.message}`));
        }
